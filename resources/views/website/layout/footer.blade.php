    ...
    <div class="container">
            ...
            <div class="col-md-4">
                <div class="ftco-footer-widget mb-4">
                    ...
                    <div class="block-21 mb-4 d-flex">
                        <a class="blog-img mr-4" style="background-image: url({{url('template/images/image_1.jpg')}});"></a>
                        <div class="text">
                    ...
                    <div class="block-21 mb-4 d-flex">
                        <a class="blog-img mr-4" style="background-image: url({{url('template/images/image_2.jpg')}});"></a>
                        <div class="text">
                            <h3 class="heading"><a href="#">Even the all-powerful Pointing has no control
                                    about</a></h3>
                            <div class="meta">
        ...
        <div class="row">
            <div class="col-md-12 text-center">
                <p>
                    {{__('content.footer')}} | <a href="https://alareenwear.com" target="_blank">ALAreenWear.com</a>
                </p>
            </div>
        </div>
    </div>
